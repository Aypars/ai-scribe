  ...
  return (
    <div className="flex min-h-full flex-1">
      <section className="relative hidden w-[46%] flex-col justify-between overflow-hidden bg-slate-950 px-12 py-12 text-slate-100 lg:flex">
        ...
        <p className="relative text-sm font-semibold tracking-[0.2em] text-teal-300">
          AI-SCRIBE
        </p>
        <div className="relative max-w-md">
          ...
          <p className="mt-4 text-base leading-7 text-slate-300">
            Ses kaydını yükle; transkript, özet ve aksiyon maddeleri otomatik
            çıksın. Görevleri tek panodan takip et.
          </p>
          <ul className="mt-8 space-y-3 text-sm text-slate-200">
            <li className="flex gap-3">
              <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-teal-400" />
              Whisper ile zaman damgalı transkript
            </li>
            <li className="flex gap-3">
              <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-teal-400" />
              Özet, alınan kararlar ve aksiyonlar
            </li>
            <li className="flex gap-3">
              <span className="mt-1 h-1.5 w-1.5 shrink-0 rounded-full bg-teal-400" />
              Aksiyonlardan görev kartı
            </li>
          </ul>
        </div>
      ...
      <section className="relative flex flex-1 items-center justify-center bg-slate-50 px-6 py-12 dark:bg-[#071314]">
        ...
        <div className="w-full max-w-md">
          <div className="mb-8 lg:hidden">
            ...
            <h1 className="mt-2 text-2xl font-semibold text-slate-900 dark:text-teal-50">Hesabına giriş yap</h1>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-teal-800/40 dark:bg-[#0f2220]">
            <div className="mb-6 hidden lg:block">
              <h2 className="text-xl font-semibold text-slate-900 dark:text-teal-50">Hesabına giriş yap</h2>
              <p className="mt-1 text-sm text-slate-500">
                Toplantılarına ve görev panosuna devam et.
              </p>
            </div>
            <LoginForm />
          </div>
